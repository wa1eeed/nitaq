...
import { AlertCircle, ArrowRight, Briefcase, CheckCircle, Eye, EyeOff, KeyRound } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-muted/20">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3 text-center lg:hidden">
            ...
            <p className="text-sm text-muted-foreground">منصة المزوّد · استعادة كلمة المرور</p>
          </div>
