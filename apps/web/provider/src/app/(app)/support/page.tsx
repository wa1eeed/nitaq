...
const FAQ = [
  ...
  { q: 'ما نسبة العمولة على كل طلب؟',        a: 'نسبة العمولة الافتراضية 8% من قيمة الطلب، وتظهر بشفافية في تفاصيل كل عملية.' },
  { q: 'كيف أضيف موظف أو خدمة جديدة؟',     a: 'من قسم "الخدمات": الموظفون أو الخدمات، ثم زر "إضافة". تظهر الخدمة فوراً وقابلة لقبول الطلبات.' },
