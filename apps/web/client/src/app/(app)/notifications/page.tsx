...
// API notification (mirrors Prisma): { id, type, titleAr, bodyAr, isRead, createdAt }
...
export default function ClientNotificationsPage() {
  ...
  // Live API result wins; falls back to mock for offline demo. Both shapes
  // are mapped to a unified renderer shape below.
  const items = useMemo(() => {
    ...
    return notificationsFor('client');
  }, [data]);
