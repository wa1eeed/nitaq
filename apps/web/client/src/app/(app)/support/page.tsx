...
const CATEGORY_LABELS: Record<string, string> = {
  ...
  TECHNICAL: 'مشكلة تقنية', KYC: 'اعتماد KYC', DRIVER: 'موظف', OTHER: 'أخرى',
  GENERAL: 'استفسار عام',
};

const FAQ = [
  { q: 'كيف أضمن جودة الخدمة؟',          a: 'كل المزودين على المنصة معتمدون وموثّقون، وكل طلب محمي بضمان المنصة.' },
  { q: 'متى تُسدّد الفاتورة للمزوّد؟',    a: 'تُحتجز قيمة الطلب في حساب Escrow حتى تأكيد الإنجاز، ثم تُفرَج للمزوّد خلال 3 أيام عمل.' },
  { q: 'هل يمكنني تتبّع سير الطلب؟',     a: 'نعم، يمكنك متابعة تقدّم أي طلب لحظياً من صفحة التتبع داخل تفاصيل الطلب.' },
