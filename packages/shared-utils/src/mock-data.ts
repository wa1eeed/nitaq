...
export type TruckType =
  | 'CONSULTING' | 'DESIGN' | 'INSTALLATION' | 'MAINTENANCE'
  | 'TECHNICAL_SUPPORT' | 'TRAINING' | 'IT_SERVICES'
  | 'LOGISTICS' | 'PROJECT_MANAGEMENT' | 'OTHER';

export type CargoType = TruckType;
...
export const ORDERS: Order[] = [
  { id: 'ORD-2025-0142', orderNumber: 'ORD-2025-0142', status: 'COMPLETED',  mode: 'OPEN',   clientId: 'CL-1001', carrierId: 'CR-2003', cargoType: 'INSTALLATION',      cargoDescription: 'تركيب منظومة كاميرات مراقبة في المستودع',   truckType: 'INSTALLATION',     originCity: 'الرياض',  originAddress: 'حي السلي، المستودع الرئيسي', destinationCity: 'الرياض',  destinationAddress: 'حي السلي، المستودع الرئيسي', pickupDate: '2026-04-10T08:00:00Z', deliveryDate: '2026-04-12T16:30:00Z', clientBudget: 110000, agreedPrice: 105580, carrierAmount: 97134, commission:  8446, requiresInsurance: true,  requiresRefrigeration: false, createdAt: '2026-04-05T12:00:00Z', bidCount: 5 },
  { id: 'ORD-2025-0148', orderNumber: 'ORD-2025-0148', status: 'DELIVERED',  mode: 'OPEN',   clientId: 'CL-1005', carrierId: 'CR-2002', cargoType: 'MAINTENANCE',   cargoDescription: 'صيانة دورية لمنظومة التكييف المركزي',        truckType: 'MAINTENANCE',      originCity: 'جدة',     originAddress: 'مقر الشركة، حي العزيزية', destinationCity: 'جدة', destinationAddress: 'مقر الشركة، حي العزيزية',         pickupDate: '2026-05-08T05:00:00Z', deliveryDate: '2026-05-09T09:00:00Z', clientBudget: 50000,  agreedPrice:  48784, carrierAmount: 44881, commission:  3903, requiresInsurance: true,  requiresRefrigeration: false, createdAt: '2026-05-02T09:30:00Z', bidCount: 7 },
  { id: 'ORD-2025-0150', orderNumber: 'ORD-2025-0150', status: 'IN_TRANSIT', mode: 'OPEN',   clientId: 'CL-1001', carrierId: 'CR-2001', cargoType: 'TECHNICAL_SUPPORT', cargoDescription: 'دعم تقني لأنظمة ERP وقواعد البيانات',         truckType: 'TECHNICAL_SUPPORT', originCity: 'الرياض', originAddress: 'المنطقة الصناعية الثانية', destinationCity: 'الرياض', destinationAddress: 'المنطقة الصناعية الثانية',    pickupDate: '2026-05-13T07:00:00Z', clientBudget: 95000,  agreedPrice:  80464, carrierAmount: 74027, commission:  6437, requiresInsurance: true,  requiresRefrigeration: false, createdAt: '2026-05-10T11:20:00Z', bidCount: 6 },
  { id: 'ORD-2025-0155', orderNumber: 'ORD-2025-0155', status: 'BIDDING',    mode: 'OPEN',   clientId: 'CL-1002', cargoType: 'IT_SERVICES',   cargoDescription: 'تطوير تطبيق إدارة المستودعات وتكاملاته',     truckType: 'IT_SERVICES',       originCity: 'جدة',     originAddress: 'مكاتب المنارة، حي الروضة', destinationCity: 'جدة', destinationAddress: 'مكاتب المنارة، حي الروضة',    pickupDate: '2026-05-17T09:00:00Z', clientBudget: 12000,  agreedPrice: null,                                            requiresInsurance: true,  requiresRefrigeration: false, createdAt: '2026-05-12T14:15:00Z', bidCount: 4 },
  { id: 'ORD-2025-0160', orderNumber: 'ORD-2025-0160', status: 'PUBLISHED',  mode: 'OPEN',   clientId: 'CL-1005', cargoType: 'TRAINING',      cargoDescription: 'تدريب فريق المبيعات على منظومة CRM',          truckType: 'TRAINING',          originCity: 'الرياض', originAddress: 'مقر الشركة، حي العليا', destinationCity: 'الرياض', destinationAddress: 'مقر الشركة، حي العليا',          pickupDate: '2026-05-17T05:00:00Z', clientBudget: 26000,  agreedPrice: null,                                            requiresInsurance: true,  requiresRefrigeration: false, createdAt: '2026-05-13T08:00:00Z', bidCount: 0 },
  { id: 'ORD-2025-0162', orderNumber: 'ORD-2025-0162', status: 'PUBLISHED',  mode: 'OPEN',   clientId: 'CL-1003', cargoType: 'CONSULTING',    cargoDescription: 'استشارات هندسية لمشروع توسعة المصنع',         truckType: 'CONSULTING',        originCity: 'الدمام', originAddress: 'مجمع المكاتب، حي الشاطئ',  destinationCity: 'الدمام', destinationAddress: 'مجمع المكاتب، حي الشاطئ',        pickupDate: '2026-05-19T06:00:00Z', clientBudget:  8400,  agreedPrice: null,                                            requiresInsurance: false, requiresRefrigeration: false, createdAt: '2026-05-13T10:30:00Z', bidCount: 0 },
  { id: 'ORD-2025-0165', orderNumber: 'ORD-2025-0165', status: 'DRAFT',      mode: 'OPEN',   clientId: 'CL-1004', cargoType: 'OTHER',         cargoDescription: '— لم يُكتمل بعد —',                          truckType: 'OTHER',             originCity: 'الرياض', originAddress: '— لم يُحدّد بعد —',         destinationCity: 'الرياض',  destinationAddress: '— لم يُحدّد بعد —',               pickupDate: '2026-05-18T09:00:00Z', clientBudget: 0,      agreedPrice: null,                                            requiresInsurance: false, requiresRefrigeration: false, createdAt: '2026-05-13T16:00:00Z', bidCount: 0 },
  { id: 'ORD-2025-0145', orderNumber: 'ORD-2025-0145', status: 'CANCELLED',  mode: 'OPEN',   clientId: 'CL-1005', cargoType: 'PROJECT_MANAGEMENT', cargoDescription: 'إدارة مشروع التحول الرقمي للمؤسسة',         truckType: 'PROJECT_MANAGEMENT', originCity: 'الرياض', originAddress: 'حي العليا',                destinationCity: 'الرياض',  destinationAddress: 'حي العليا',                         pickupDate: '2026-05-15T10:00:00Z', clientBudget: 30000,  agreedPrice:  30800, carrierAmount: 28336, commission:  2464, requiresInsurance: false, requiresRefrigeration: false, createdAt: '2026-05-09T11:00:00Z', bidCount: 3 },
  // Direct request example
  { id: 'ORD-2025-0170', orderNumber: 'ORD-2025-0170', status: 'PUBLISHED',  mode: 'DIRECT', targetCarrierId: 'CR-2003', clientId: 'CL-1001', cargoType: 'DESIGN', cargoDescription: 'تصميم هوية بصرية شاملة للعلامة التجارية', truckType: 'DESIGN', originCity: 'الجبيل', originAddress: 'مقر الشركة، حي الجوهرة', destinationCity: 'الجبيل', destinationAddress: 'مقر الشركة، حي الجوهرة', pickupDate: '2026-05-20T05:00:00Z', clientBudget: 165000, agreedPrice: null, requiresInsurance: true, requiresRefrigeration: false, specialInstructions: 'يلزم عرض تقديمي للإدارة خلال أسبوع من الاستلام', createdAt: '2026-05-13T19:00:00Z', bidCount: 0 },
];

// ─── Bids ─────────────────────────────────────────────────────────────

export const BIDS: Bid[] = [
  // Bids for ORD-2025-0155 (BIDDING) - 4 competing providers
  { id: 'BID-3001', orderId: 'ORD-2025-0155', carrierId: 'CR-2001', price: 11500, estimatedDays: 1, truckType: 'IT_SERVICES', notes: 'فريق متخصص في أنظمة ERP وتكاملات API.',     status: 'PENDING', createdAt: '2026-05-12T15:00:00Z' },
  { id: 'BID-3002', orderId: 'ORD-2025-0155', carrierId: 'CR-2003', price: 10800, estimatedDays: 1, truckType: 'IT_SERVICES', notes: 'خبرة 5 سنوات في تطوير تطبيقات المستودعات.',  status: 'PENDING', createdAt: '2026-05-12T16:20:00Z' },
  { id: 'BID-3003', orderId: 'ORD-2025-0155', carrierId: 'CR-2002', price: 12200, estimatedDays: 2, truckType: 'IT_SERVICES',                                                        status: 'PENDING', createdAt: '2026-05-12T17:45:00Z' },
  { id: 'BID-3004', orderId: 'ORD-2025-0155', carrierId: 'CR-2005', price: 11200, estimatedDays: 1, truckType: 'IT_SERVICES', notes: 'مشاريع مكتملة لعملاء في القطاع الصناعي.',    status: 'PENDING', createdAt: '2026-05-12T19:10:00Z' },

  // Historical bids for completed orders
  { id: 'BID-3005', orderId: 'ORD-2025-0142', carrierId: 'CR-2003', price: 105580, estimatedDays: 2, truckType: 'INSTALLATION', status: 'ACCEPTED',  createdAt: '2026-04-05T13:30:00Z' },
  { id: 'BID-3006', orderId: 'ORD-2025-0142', carrierId: 'CR-2001', price: 108200, estimatedDays: 2, truckType: 'INSTALLATION', status: 'REJECTED',  createdAt: '2026-04-05T14:00:00Z' },
  { id: 'BID-3007', orderId: 'ORD-2025-0148', carrierId: 'CR-2002', price:  48784, estimatedDays: 1, truckType: 'MAINTENANCE',  status: 'ACCEPTED',  createdAt: '2026-05-02T11:00:00Z' },
  { id: 'BID-3008', orderId: 'ORD-2025-0150', carrierId: 'CR-2001', price:  80464, estimatedDays: 2, truckType: 'TECHNICAL_SUPPORT', status: 'ACCEPTED', createdAt: '2026-05-10T13:00:00Z' },
];

// ─── Fleet (Carrier-side) — sample for CR-2001 (logged-in carrier) ───

export const TRUCKS: Truck[] = [
  { id: 'TRK-001', carrierId: 'CR-2001', plateNumber: 'SVC-0001', truckType: 'INSTALLATION',      capacityKg: 1, modelYear: 2023, status: 'ON_TRIP',     lastInspection: '2026-03-15T00:00:00Z', assignedDriverId: 'DRV-001' },
  { id: 'TRK-002', carrierId: 'CR-2001', plateNumber: 'SVC-0002', truckType: 'MAINTENANCE',        capacityKg: 1, modelYear: 2024, status: 'AVAILABLE',   lastInspection: '2026-04-02T00:00:00Z' },
  { id: 'TRK-003', carrierId: 'CR-2001', plateNumber: 'SVC-0003', truckType: 'TECHNICAL_SUPPORT',  capacityKg: 1, modelYear: 2022, status: 'AVAILABLE',   lastInspection: '2026-02-20T00:00:00Z', assignedDriverId: 'DRV-002' },
  { id: 'TRK-004', carrierId: 'CR-2001', plateNumber: 'SVC-0004', truckType: 'CONSULTING',         capacityKg: 1, modelYear: 2021, status: 'MAINTENANCE', lastInspection: '2026-01-08T00:00:00Z' },
  { id: 'TRK-005', carrierId: 'CR-2001', plateNumber: 'SVC-0005', truckType: 'IT_SERVICES',        capacityKg: 1, modelYear: 2023, status: 'AVAILABLE',   lastInspection: '2026-04-30T00:00:00Z', assignedDriverId: 'DRV-003' },
];
